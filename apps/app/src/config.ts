...
export const config = {
    ...
    memwalServerUrl: import.meta.env.VITE_MEMWAL_SERVER_URL as string || DEFAULT_MEMWAL_SERVER_URL,
    ...
    docsUrl: import.meta.env.VITE_DOCS_URL as string || DEFAULT_DOCS_URL,
