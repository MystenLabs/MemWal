...
ARG NEXT_PUBLIC_WALRUS_AGGREGATOR=https://aggregator.walrus-testnet.walrus.space
ARG NEXT_PUBLIC_WALRUS_PUBLISHER=https://publisher.walrus-testnet.walrus.space
ARG NEXT_PUBLIC_WALRUS_UPLOAD_RELAY=https://upload-relay.testnet.walrus.space
ARG NEXT_PUBLIC_WALRUS_EPOCHS=5
...
ENV NEXT_PUBLIC_WALRUS_AGGREGATOR=$NEXT_PUBLIC_WALRUS_AGGREGATOR
ENV NEXT_PUBLIC_WALRUS_PUBLISHER=$NEXT_PUBLIC_WALRUS_PUBLISHER
ENV NEXT_PUBLIC_WALRUS_UPLOAD_RELAY=$NEXT_PUBLIC_WALRUS_UPLOAD_RELAY
ENV NEXT_PUBLIC_WALRUS_EPOCHS=$NEXT_PUBLIC_WALRUS_EPOCHS
