...
//!   (paired with the future `Retriever` trait that exposes BM25).
//!
//! Adding any of these is the work of a follow-up task. This file exists so
//! the structural home is named and discoverable.
