-- services/server/migrations/015_memory_read_api_updated_at_not_null.sql
--
...
-- Migration 019 then does the actual `SET NOT NULL`, which since PG 12
...
--
-- Both steps are guarded by `pg_attribute.attnotnull` so that once 019
...
-- restart forever.
--
-- The column's DEFAULT is set by migration 014, not here -- see 014's
