...
export const PROACTIVE_INSTRUCTIONS = [
    ...
    "",
    "REMEMBER: only persist a fact that will still matter in a later session or on another machine",
    "(a stable preference, project decision, hard constraint, correction, or identity). Writes are",
    "expensive — skip one-off tasks, the current file or bug, small talk, and anything already stored.",
    "When that bar is met, call memwal_remember without waiting to be asked. Pass the complete",
    "statement rather than a summary. Use memwal_remember_bulk for several distinct high-value facts.",
    "",
