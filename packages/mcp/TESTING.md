...
|---|---|---|
| npm prerelease | `release-mcp.yml` (path `packages/mcp/**`) | `@mysten-incubation/memwal-mcp@0.0.10-dev.N` under the `dev` dist-tag (`latest` stays 0.0.9 until `main`) |
...
- [ ] `npm view @mysten-incubation/memwal-mcp dist-tags` — `dev` points at `0.0.10-dev.N`; after main merge, `latest` = `0.0.10`
