...
description: An AI chat app that keeps persistent memory across sessions by wrapping its model with the Walrus Memory AI middleware.
keywords: [chatbot, example app, AI middleware, withMemWal, recall, auto-save, Vercel AI SDK, Next.js]
---
