---
title: Self-Hosting
description: Run your own Walrus Memory relayer, from a quick local start to environment variables, Seal key servers, database setup, and horizontal scaling.
keywords: [self-hosting, relayer, deployment, environment variables, Seal key servers, PostgreSQL, pgvector, Redis, gRPC, scaling]
---
...
If you want the default relayer-handled SDK flow while reducing trust in the host operator, see the [TEE Deployment Pattern](/relayer/nautilus-tee).
