...
title: Self-Hosting
description: >-
  Guide to self-hosting the Walrus Memory relayer, covering environment variables, database setup, horizontal scaling, and Seal key server configuration for running your own dedicated MemWal backend.
keywords:
  - Walrus Memory
  - MemWal
  - self-hosting
