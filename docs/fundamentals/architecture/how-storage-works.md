...
<iframe src="/diagrams/interactive_walrus-memory-storage_v1.html" style={{width:'100%',height:'750px',border:'0'}} title="How Walrus Memory storage works" loading="lazy"></iframe>
